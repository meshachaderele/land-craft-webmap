...
function ensureLoadingOverlay() {
  ...
  if (!overlay) {
    ...
    overlay.innerHTML = `<div class="loader-wrapper">
    ...
    Object.assign(overlay.style, {
      ...
      zIndex: 10000, fontFamily: 'sans-serif', color: '#333'
    });
    const spinner = overlay.querySelector('.spinner');
    Object.assign(spinner.style, {
      width: '70px', height: '70px', border: '8px solid #ddd',
      borderTop: '8px solid #007BFF', borderRadius: '50%',
...
function showLoading(){ ensureLoadingOverlay().style.display = 'flex'; }
